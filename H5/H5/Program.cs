    ...
    class Program
    {
        static void Main(string[] args)
        {
            ...
            while (opid != 6)
            {
                ...
                opid = OrderIO.readInt(6);
                Console.Clear();
                switch (opid)
                {
                    case 1: OrderService.AddOrder(); break;
                    case 2: OrderService.ModifyOrder(); break;
                    case 3: OrderService.DeleteOrder(); break;
                    case 4: OrderService.QueryOrder(); break;
                    case 5: OrderIO.PrintOrderList(OrderService.OrderList); break;
                    case 6: OrderIO.PrintWarning("再见！"); return;
                    default: OrderIO.PrintWarning("输入非法，请重新输入！"); break;
                }
                OrderIO.returnMain();
            }
        }
